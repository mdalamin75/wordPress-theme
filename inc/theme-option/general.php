        ...
        <div id="theme_option_body">
            <div class="main_area_option">
                ...
                <form action="options.php" method="post">
                    ...
                    <input type="text" name="phone-number" value="<?php echo get_option('phone-number'); ?>" placeholder="Enter Your Phone Number">

                    <input type="hidden" name="action" value="update">
                    <input type="hidden" name="page_options" value="address-info, email-info, phone-number">
                    <input type="submit" name="submit" value="<?php _e('Save Info', 'mdalamin') ?>">
                </form>
            </div>
        </div>
    <?php 
